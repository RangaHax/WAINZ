...
def submission_details(request):
    ...
    if(request.method == 'POST'):
        ...
        tmpImagePath = os.path.join("static/tmp/%s.%s" % (hashname, extension))
        ImagePath = os.path.join("static/uploaded-images/%s.%s" % (hashname, extension))
        ThumbImagePath = os.path.join("static/uploaded-images/%s-thumb.%s" % (hashname, extension))
